            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <motion.div
                        ...
                        className="lg:w-1/2"
                    >
                        <form onSubmit={handleSubmit} className="p-8 rounded-2xl bg-surface/50 backdrop-blur-md border border-white/10 shadow-2xl">
                            {status === 'success' && <p className="mb-4 text-green-400">Message sent successfully!</p>}
                            {status === 'error' && <p className="mb-4 text-red-400">Failed to send message. Please try again.</p>}
                            ...
                            >
                                {status === 'sending' ? 'Sending...' : 'Send Request'} <Send className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                            </button>
                        </form>
                    </motion.div>
                </div>
